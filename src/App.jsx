...
function App() {
  ...
  async function handleCsvFile(file) {
    ...
    const mapped = mapCsvRowsToHoldings(rows, file.name);
    ...
    <div className="app">
      ...
      {tab === "prompt" && (
        <section className="card">
          ...
          <button onClick={() => navigator.clipboard.writeText(generatedPrompt)}><Copy size={16} /> コピー</button>
